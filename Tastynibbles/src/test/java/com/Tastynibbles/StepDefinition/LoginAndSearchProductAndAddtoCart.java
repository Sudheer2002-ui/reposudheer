...
public class LoginAndSearchProductAndAddtoCart {
	...
	public void user_enters_the_login_credentials(DataTable dataTable) throws Exception {
		List<List<String>> credentials = credentials(
				"C:\\Users\\sudhe\\eclipse-workspace\\ind\\Tastynibbles\\src\\test\\resources\\Testdata.xlsx");
	...
	public void user_search_for_a_product(String string) throws CustomizedException {
	    ProductSearchPage.searchProduct(string);
	}

	@And("User selects {string} the product")
	public void user_selects_the_product(String string) throws CustomizedException {
		   ProductSearchPage.selectProduct(string);
	}
	@Then("User clicks on Add to cart button")
	public void user_clicks_on_add_to_cart_button() throws CustomizedException {
	  ProductSearchPage.addItemToCart();
	}

	@And("User Verifies the product {string} in cart")
	public void user_verifies_the_product_in_cart(String string) throws CustomizedException {
