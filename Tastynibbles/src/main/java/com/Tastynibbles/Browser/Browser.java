...
public class Browser {
    ...
    public static void init(String reportName) {
    		 ...
    		 String reportPath = System.getProperty("user.dir") + "//target//ExtentReports//" + reportName +".html";
    ...
    public static void openBrowser() throws Exception {
        ...
        try {
            ...
            logger1.log(Status.FAIL, "Browser Opening is unsuccessful");
        }
    }
    ...
    public static void navigateToUrl(String url) throws Exception {
        ...
        try {
            ...
            logger1.log(Status.FAIL, "Navigating To Url is unsuccessful");
        }
    }
    ...
    public static void closeBrowser() {
        ...
        try {
            ...
            logger1.log(Status.FAIL, "Closing the Browser is unsuccessful");
        }
    }
}
